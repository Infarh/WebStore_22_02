...
public class CatalogControllerTests
{
    ...
    public void Details_Returns_with_View()
    {
        ...
        product_data_mock.Setup(s => s.GetProductById(It.IsAny<int>()))
        ...
        configuration_mock.Setup(cfg => cfg["CatalogPageSize"]).Returns("3");
        ...
        product_data_mock.Verify(s => s.GetProductById(It.Is<int>(id => id == expected_id)));
